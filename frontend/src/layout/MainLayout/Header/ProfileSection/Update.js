...
const SettingsPage = () => {
    ...
    const handleEmailUpdate = async () => {
        try {
            ...
            await axios.put(`http://localhost:8080/api/professors/${id}/email`, updatedProfessor);
    ...
    const handlePasswordUpdate = async () => {
        try {
            ...
            await axios.put(`http://localhost:8080/api/professors/${id}/password`, updatedProfessor);
    ...
    const handleResetData = async () => {
        try {
            ...
            const response = await axios.post('http://localhost:8080/api/auth/confirm-password', {
            ...
            if (response.data === 'Password confirmed successfully.') {
                ...
                const deleteSessionsResponse = await axios.delete('http://localhost:8080/api/session/deleteAll');
                const deleteStudentsResponse = await axios.delete('http://localhost:8080/api/students/deleteAll');
