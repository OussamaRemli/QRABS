        ...
        const fetchData = async () => {
            try {
                ...
                if (token) {
                    ...
                    const response = await axios.get(`http://localhost:8080/api/session/sessions/${parseInt(tokenPayload.id, 10)}`);
...
// Front-end code for updating e-mail
    const handleEmailUpdate = async () => {
        try {
            ...
            await axios.put(`http://localhost:8080/api/professors/${professorId}/email`, professorData);
...
// Front-end code for updating password
    ...
    const handlePasswordUpdate = async () => {
        ...
        try {
            ...
            await axios.put(`http://localhost:8080/api/professors/${professorId}/password`, professorData);
