...
import faceScanImage from "../../../assets/images/face-scan.png"; // Import your image here
import './Countdown.css'
import AnimatedImage from './annimation';
...
const Qrcode = ({levelId,sessionId,group}) => {
    ...
    const captureAndSend = async () => {
        ...
        try {
            const response = await axios.post(`${process.env.REACT_APP_FLASK_BASE_URL}/api`, {sessionId: sessionId, group: group });
            ...
            >
                <CardContent>
                    ...
                    {!isDone.includes(levelId) ? (
                        ...
                        <Grid container alignItems="center" justifyContent="center" className="fade-in">
                        <TaskAltIcon className="animated-icon" color="success" sx={{ fontSize: 200 }} />
                    </Grid>
