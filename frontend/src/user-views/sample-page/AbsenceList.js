...
function AbsenceList({ levelId, moduleId, onButtonClick }) {
    ...
    // Function to get row class name based on absence count
    const getRowClassName = (params) => {
        return params.row.Nombredabsence >= 3 ? 'row-red' : '';
    };
            ...
            <Grid item>
                ...
                >
                    <DataGrid
                        ...
                        getRowClassName={getRowClassName} // Apply row class name based on condition
                        sx={{
                            ...
                            // Modify the row-red style to use a lighter red color
'& .row-red': {
    backgroundColor: '#ffcccc !important', // Lighter red color
