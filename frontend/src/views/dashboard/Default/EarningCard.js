...
//   useEffect(() => {
//     // Vérifier si le niveau a un emploi du temps
//     axios.get(`http://localhost:8080/api/levels/has-schedule?levelName=${abr}`)
//       .then(response => {
//         setHasSchedule(response.data);
//       })
//       .catch(error => console.error('Il y a eu une erreur!', error));

//     // Vérifier si le niveau a des étudiants
//     axios.get(`http://localhost:8080/api/levels/has-students?levelName=${abr}`)
//       .then(response => {
...
//   )}
// </IconButton>
//         <Typography variant="subtitle1" style={{ color: '#FFF', marginLeft: '5px', fontSize: '0.7rem' }}>Emploi du temps</Typography>
//       </Grid>
//       <Grid item container alignItems="center" xs={6}>
//         <IconButton size="small">
//           {hasStudents ? (
...
//           )}
//         </IconButton>
//         <Typography variant="subtitle1" style={{ color: '#FFF', marginLeft: '5px', fontSize: '0.7rem' }}>Liste des étudiants</Typography>
//       </Grid>
//     </Grid>
